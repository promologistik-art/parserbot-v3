...
class Config:
    ...
    YOUTUBE_VIDEO_DURATION_MAX = int(os.getenv("YOUTUBE_VIDEO_DURATION_MAX", "600"))  # 10 минут
    YOUTUBE_VIDEO_QUALITY = os.getenv("YOUTUBE_VIDEO_QUALITY", "720p")
    ...
    def validate(cls):
        ...
        if not cls.YOUTUBE_API_KEY:
            print("⚠️ YOUTUBE_API_KEY not set. YouTube features will not work.")
